...
<div class=" cta2 xl:pb-24 pb-12 sm:pt-0 pt-8">
      ...
      <div class="container mx-auto">
        <div id="subscribe2" data-aos="zoom-out" class="xl:w-3/5 lg:w-3/5 w-10/12 mx-auto p-8 bg-black bg-opacity-60 block">
          ...
          <div class="flex flex-col xl:flex-row lg:flex-row md:flex-row w-full justify-center">
            <input id="email2" bind:value={emailid} type="text" placeholder="Your Email" aria-label="email" class="focus:outline-none xl:w-6/12 lg:w-9/12 w-full mb-2 xl:mb-0 lg:mb-0 md:mb-0 md:w-8/12 py-3 px-4 focus:border-our-blue border border-white rounded shadow text-black" />
